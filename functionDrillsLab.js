...
let str1 = "I am a "
let str2 = "Javascript Ninja!"

let jsNinja = (str1, str2) => str1 + str2;
console.log(jsNinja(str1, str2))
...
const is_Ascending = (input_array) => {
  let numberToCompare = input_array[0]
  for (let i = 1; i < input_array.length; i++){
    let currentNumber = input_array[i]
